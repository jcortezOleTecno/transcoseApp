...
class _$_EnrollTrainingState extends _EnrollTrainingState {
  const _$_EnrollTrainingState() : super._();
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$_EnrollTrainingState);
  }
...
abstract class _EnrollTrainingState extends EnrollEventState {
  const factory _EnrollTrainingState() = _$_EnrollTrainingState;
