...
import 'package:vemare/app/view/shopping_cart/data_pay.dart';
import 'package:vemare/app/view/theme/text_style.dart';

import '../_components/my_button/my_back_button.dart';
import '../theme/color.dart';

class ShoppingCarArgs {
...
class ShippingDataPage extends StatelessWidget {
  const ShippingDataPage(this.args, {super.key});
  static const route = '/shipping_data';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    MyButton(
                      onPressed: () {
                        if (args.isCard) {
                          Navigator.pushNamed(context, DataPayPage.route,
                              arguments: args);
                        } else {
