...
class _$MyAccountStateImpl implements _MyAccountState {
  ...
  @override
  String toString() {
    return 'MyAccountState(status: $status, name: $name, email: $email, code: $code, cif: $cif, phone: $phone, address: $address, city: $city, province: $province, postalCode: $postalCode, foto: $foto)';
  }
