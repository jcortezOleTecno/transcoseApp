...
class Webservice {
  Webservice({
    ...
    this.dias_periodo_devolucion = 0,
  });
  ...
  factory Webservice.fromJson(Map<String, dynamic> json) => Webservice(
    ...
    dias_periodo_devolucion: json["dias_periodo_devolucion"] ?? 0,
  ...
  Map<String, dynamic> toJson() => {
    ...
    "dias_periodo_devolucion": dias_periodo_devolucion,
